...
btnsin = tkinter.Button(root,text = 'sin',font = ('微软雅黑',20),fg = ('#4F4F4F'),bd = 0.5,command = lambda:pressCompute('sin'))
btnsin.place(x = 0,y = 505,width = 70,height = 55)
